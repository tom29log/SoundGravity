    ...
    return (
        <div className="flex gap-8 items-start overflow-x-auto pb-4">
            ...
            <div className="flex-shrink-0 space-y-2">
                ...
                <div className="w-[300px] h-[600px] border-4 border-zinc-700 rounded-3xl overflow-hidden bg-black relative">
                    <iframe
                        src={url}
            ...
            <div className="flex-shrink-0 space-y-2">
                ...
                <div className="w-[640px] h-[360px] border-4 border-zinc-700 rounded-lg overflow-hidden bg-black relative">
                    <iframe
                        src={url}
